...
class L3GD20(object):
    ...
    def Init(self):
        ...
        #print("Initiating...")                         #Commented out print here
    ...
    def CalibrateX(self):
        ...
        #print("Calibrating axis X, please do not move sensor...")      #Commented out print here
        buff = []
        for t in range(20):
    ...
    def Calibrate(self):
        self.CalibrateX()	#changed indentation
        self.CalibrateY()
        self.CalibrateZ()
